...
import 'profilegallery_model.dart';
export 'profilegallery_model.dart';

class ProfilegalleryWidget extends StatefulWidget {
  const ProfilegalleryWidget({Key? key}) : super(key: key);

  @override
  _ProfilegalleryWidgetState createState() => _ProfilegalleryWidgetState();
}
